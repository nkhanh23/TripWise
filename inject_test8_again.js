...
text = text.replace(
  ...
  "const markersDimmed = confirmedCategory !== selectedCategory && (normalizedStatus === 'refreshing' || hasBackgroundError); console.log('TEST 8 CHECK:', confirmedCategory, selectedCategory, normalizedStatus, hasBackgroundError, markersDimmed, 'places=', places.length);"
);
