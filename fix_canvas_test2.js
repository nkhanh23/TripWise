...
// And check ExploreProductionScreen.test.tsx syntax
const prodText = fs.readFileSync('mobile/tests/ExploreProductionScreen.test.tsx', 'utf8');
if (!prodText.includes('import { ExploreMotionHint } from \'../src/features/explore/components/ExploreMotionHint\';')) {
  console.log('Prod test missing imports');
}
