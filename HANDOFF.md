# TripWise Handoff Index

Tài liệu handoff được tách theo ownership để Backend và React Native Mobile Frontend có thể phát triển độc lập:

- Backend status → [`HANDOFF_BE.md`](./HANDOFF_BE.md)
- Mobile Frontend status → [`HANDOFF_FE.md`](./HANDOFF_FE.md)
- FE ↔ BE integration → [`HANDOFF_INTEGRATION.md`](./HANDOFF_INTEGRATION.md)
