          ...
          <div className={styles.leftCol}>
            ...
            <Card className={styles.continueCard}>
              <div className={styles.continueContent}>
                <h3 className={styles.continueTitle}>Đang lên kế hoạch dở</h3>
                <h2 className={styles.continueTripName}>Chuyến đi Nha Trang 3 ngày 2 đêm</h2>
                
                <div className={styles.continueBadges}>
                  <span className={styles.badgeNeutral}>Nháp</span>
                  <span className={styles.badgeSuccess}>Đã có 70% lịch trình</span>
                  <span className={styles.badgeWarn}>Budget vừa phải</span>
                </div>
                ...
                <div className={styles.continueActions}>
                  <Button variant="primary" onClick={() => router.push('/planner')}>Tiếp tục thiết lập ⚡</Button>
                  <Button variant="secondary" onClick={() => router.push('/planner')}>Tạo lại bằng AI</Button>
            ...
            <section className={styles.aiSugSection}>
              ...
              <div className={styles.aiSugList}>
                {aiSuggestions.map((sug, idx) => (
                  <Card key={idx} className={styles.aiSugCard}>
                    <div className={styles.aiSugBadgeWrapper}>
                      <span className={styles.aiSugBadge}>{sug.badge} AI</span>
                    </div>
