...
text = text.replace(
  /const {\s*places, status, category: selectedCategory, setCategory: setSelectedCategory,\s*onRegionChangeComplete, retry,\s*} = useExploreDiscovery\(repository, initialPlaces, initialStatus\);/,
...
console.log('Fixed variables with regex');
