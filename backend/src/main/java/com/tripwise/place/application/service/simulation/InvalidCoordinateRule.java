...
@Component
public class InvalidCoordinateRule implements AutoModerationRule {
    @Override
    public boolean evaluate(StagingPlaceDetailResponse detail) {
        return detail.getStagingPlace() != null && "INVALID".equals(detail.getStagingPlace().getCoordinateStatus());
    }
