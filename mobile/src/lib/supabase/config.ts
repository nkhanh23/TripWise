...
export function readSupabaseConfig(environment: Record<string, string | undefined>): SupabaseConfig {
  ...
  try {
    ...
    throw new SupabaseConfigurationError('EXPO_PUBLIC_SUPABASE_URL must be a valid HTTP(S) URL.');
  }
