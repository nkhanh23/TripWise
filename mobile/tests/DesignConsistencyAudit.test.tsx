...
describe("Design Consistency Audit (FE-P18-T001)", () => {
  ...
  describe("1. Matrix: Light + EN (Baseline Stitch Alignment)", () => {
    ...
    it("renders Explore in Light + EN", async () => {
      await renderMatrix(
        <ExploreScreen initialPlaces={mockExplorePlaces} />,
        "light",
        "en",
      );
      expect(
    ...
    it("renders Route Preview in Light + EN", async () => {
      ...
      expect(screen.getByText("Wat Arun")).toBeTruthy();
      expect(
        screen.getAllByText("Current Location").length,
    ...
    it("renders Create Trip Wizard in Light + EN", async () => {
      await renderMatrix(
        <CreateTripWizardScreen initialStep={1} />,
        "light",
        "en",
      );
  ...
  describe("2. Matrix: Light + VI (Vietnamese Localization & Hierarchy Alignment)", () => {
    ...
    it("renders Explore in Light + VI", async () => {
      ...
      expect(
        screen.getByPlaceholderText("Tìm địa điểm, quán cafe, khách sạn..."),
      ).toBeTruthy();
    });
      ...
      await renderMatrix(
        <AddPlaceScreen
          ...
          route={{
            key: "AddPlace",
            name: "AddPlace",
            params: { tripId: "trip_bangkok_2026", dayIndex: 1 },
          }}
        />,
        "dark",
        "vi",
