import {
  ...
  hasVerifiedRouteStops,
} from "../src/integration/routePlanning";
      ...
      items: [
        {
          ...
          placeName: "Second",
          resolution: "VERIFIED",
          googlePlaceId: "ChIJAAAAAAAAAAAAAAAAAA",
          latitude: 13.75,
          longitude: 100.5,
        ...
        },
        {
          ...
          placeName: "First",
          resolution: "VERIFIED",
          googlePlaceId: "ChIJBBBBBBBBBBBBBBBBBB",
          latitude: 13.74,
          longitude: 100.49,
          placeResolvedAt: "2026-08-20T00:00:00.000Z",
        },
...
describe("route planning boundary", () => {
  ...
  it("does not create a route from fewer than two verified stops", () => {
    const one = {
      ...detail,
      days: [{ ...detail.days[0], items: [detail.days[0].items[0]] }],
    } as SavedTripDetail;
