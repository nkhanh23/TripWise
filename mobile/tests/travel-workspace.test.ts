    ...
    const expenses: TripExpense[] = [
      {
        ...
        origin: "planned",
        amount: {
          local: { amount: 100, currency: "THB" },
          home: { amount: 72000, currency: "VND" },
        },
      },
      {
        id: "e2",
        ...
        origin: "actual",
        amount: {
          local: { amount: 120, currency: "THB" },
          home: { amount: 86400, currency: "VND" },
        },
      },
      {
        id: "e3",
        ...
        origin: "unplanned",
        amount: {
          local: { amount: 60, currency: "THB" },
          home: { amount: 43200, currency: "VND" },
        },
      },
    ];
