import { mapFixturePercentToCoordinate } from '../src/features/explore/utils/exploreMapUtils';
...
describe('explore fixture map coordinates', () => {
  it('maps fixture percentages into the deterministic Bangkok demo viewport', () => {
    const coordinate = mapFixturePercentToCoordinate(mockExplorePlaces[0].fixtureMapCoordinate!);
  ...
  it('clamps out-of-range fixture percentages', () => {
    const coordinate = mapFixturePercentToCoordinate({ topPercent: 200, leftPercent: -20 });
